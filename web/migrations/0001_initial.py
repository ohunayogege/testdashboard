    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(blank=True, choices=[('Verified', 'Verified'), ('Dormant', 'Dormant'), ('Suspend', 'Suspend'), ('Pending Verification', 'Pending Verification')], default='Savings', max_length=100)),
                ...
                ('account_type', models.CharField(blank=True, choices=[('Fixed Deposit', 'Fixed Deposit'), ('Savings', 'Savings'), ('Current', 'Current'), ('Dormant', 'Dormant')], default='Verified', max_length=100)),
